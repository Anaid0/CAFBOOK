...
const TutorialDetailScreen = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (!idPost) return Alert.alert("Error", "No se encontró el ID del tutorial");
  ...
  const handleSubmitComment = async () => {
    ...
    if (!userId || !postId) return Alert.alert("Error", "Falta el ID de usuario o del tutorial");
