      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.profileSection}>
          ...
          <View style={styles.userInfo}>
            ...
            <Text style={styles.userName}>Arturo Mendoza</Text>
          </View>
        </View>
        ...
        <View style={styles.optionsSection}>
          ...
          <TouchableOpacity 
            style={styles.optionButton}
            onPress={() => handleOptionPress("Mi Ubicación")}
          >
          ...
          >
            <Text style={[styles.optionText, styles.deleteText]}>Eliminar Cuenta</Text>
          </TouchableOpacity>
